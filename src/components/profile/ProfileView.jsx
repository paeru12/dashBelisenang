...
import {
    getOnePromotorMembers,
    updatePromotorMember,
    updatePromotorPassword,
...
const ProfileView = () => {
    ...
    const fetchProfile = async () => {
        ...
        const data = await getOnePromotorMembers(user.id);
        setProfile(data);
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            await updatePromotorMember(profile.id, formData);
    ...
    const handleUpdatePassword = async () => {
        ...
        try {
            await updatePromotorPassword(profile.id, passwordForm);
